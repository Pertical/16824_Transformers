...
plt.ylabel('Loss')
os.makedirs('plots{}_{}_{}'.format(num_heads, num_layers, learning_rate), exist_ok=True)
plt.title('Training loss history')
plt.savefig('plots{}_{}_{}/'.format(num_heads, num_layers, learning_rate) + exp_name + '_loss_out.png')
    ...
    for batch in loader:
      ...
      for gt_caption, sample_caption, url in zip(gt_captions, sample_captions, urls):
          ...
          if img is not None: 
            ...
            plt.axis('off')
            plt.savefig('plots{}_{}_{}/'.format(num_heads, num_layers, learning_rate) + exp_name + '_%s_%d.png' % (split, num_imgs))
            num_imgs += 1
            if num_imgs >= 5: break
      return 
